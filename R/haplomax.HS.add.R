`haplomax.HS.add` <-
function(hap.chrom1.pere,hap.chrom2.pere,hap.trans.pere,hap.trans.mere,perf,CD,genea,map,position,marq.hap) {
...
# On calcule le nombre d'allèles de l'haplotype reconstruit à gauche de la position de test
############################################################################################
